...
export const Footer: React.FC = () => {
 return (
 <footer className="py-16 md:py-24 border-t border-gray-100 mt-16">
 <Container>
 ...
 <li><Link to="/projects" className="transition hover:text-primary">Projects</Link></li>
 ...
 <li key={link.label}>
 <a href={link.href} target="_blank" rel="noreferrer" className="flex items-center space-x-3 transition hover:text-primary">
 {link.icon}
 ...
 <div className="m-auto mt-12 w-10/12 space-y-6 text-center sm:mt-auto sm:w-5/12 sm:text-left">
