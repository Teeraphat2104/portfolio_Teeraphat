...
export const ProjectDetail: React.FC = () => {
  ...
  return (
    <div className="max-w-[1000px] mx-auto px-6 pt-20 pb-16 animate-[fadeIn_0.8s_ease-out]">
      ...
      <div className="flex mt-10 pt-8 border-t border-neutral-200">
        <a
          href={project.github}
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 bg-transparent text-neutral-900 border border-neutral-200 px-5 py-2.5 rounded-lg text-sm font-medium transition-all hover:border-neutral-900 hover:bg-neutral-50 active:scale-[0.98]"
        >
